...
<div>
    <div class="header" style="text-align: center">
        <div class="pure-menu pure-menu-horizontal">
            <h1><a class="pure-menu-heading" href="" style="padding-bottom: 0; padding-top: 0">The Back Lot</a></h1>
        </div>
    </div>
    ...
    <div class="pure-g">
        <div class="photo-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-3">
            <a href="http://www.dillonmcintosh.tumblr.com/">
                <img src="https://24.media.tumblr.com/d6b9403c704c3e5aa1725c106e8a9430/tumblr_mvyxd9PUpZ1st5lhmo1_1280.jpg" alt="Beach"/>
            </a>

            <aside class="photo-box-caption">
                <p style="padding-right: 15px;">Corvette Man #1</p>
            </aside>
        </div>
        ...
        <div class="text-box pure-u-1 pure-u-md-1-2 pure-u-lg-2-3">
            <div class="l-box">
                ...
                <div class="centered">
                    <Link to="/graphic"><button>Commission Artwork</button></Link>
                </div>
            </div>
        </div>
